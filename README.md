...
```bash
ann@ub16feb:~/keras11$ 
ann@ub16feb:~/keras11$ cd ~/keras11
ann@ub16feb:~/keras11$ 
ann@ub16feb:~/keras11$ python import_keras11.py
...
```bash
ann@ub16feb:~$ 
ann@ub16feb:~$ cd ~/keras11/
ann@ub16feb:~/keras11$ 
ann@ub16feb:~/keras11$ ./flask10.bash 
Using Theano backend.
...
ann@ub16feb:~$ cd ~/keras11
ann@ub16feb:~/keras11$ 
ann@ub16feb:~/keras11$ bash -x curlem.bash
